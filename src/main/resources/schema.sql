...
CREATE TABLE IF NOT EXISTS users (  user_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,  user_name VARCHAR(255) NOT NULL,  user_email VARCHAR(512) NOT NULL,CONSTRAINT pk_user PRIMARY KEY (user_id),CONSTRAINT UQ_USER_EMAIL UNIQUE (user_email));
...
CREATE TABLE IF NOT EXISTS comments (comment_id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,text VARCHAR(255) NOT NULL,itme_id BIGINT NOT NULL,author_id BIGINT NOT NULL,CONSTRAINT pk_comments PRIMARY KEY (comment_id));